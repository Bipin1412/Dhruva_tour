...
export const fleet = [
  ...
  },
  {
    ...
    features: ["Spacious", "Roof Carrier", "Dual AC"]
  },
  {
    id: "carens",
    name: "Kia Carens",
    ...
    features: ["Luxury Seating", "Air Purifier", "Sunroof"]
  },
  {
    id: "innova",
    name: "Innova Crysta",
    ...
    features: ["Captain Seats", "Ultimate Comfort", "High Safety"]
  }
];
...
export const packages = [
  {
    ...
    duration: "~3 hrs",
    startingPrice: "₹2,500",
    image: "https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=1200&auto=format&fit=crop",
    description: "Seamless city-to-city transfer. Express expressway route for maximum time efficiency.",
    inclusions: ["Toll Taxes", "Professional Driver", "Fuel", "AC Vehicle"],
    exclusions: ["Parking (if any)", "Driver Allowance", "Extra Detours"],
    itinerary: [
      { day: "Pick Up", description: "Prompt arrival at your specified location in Pune." },
      { day: "Journey", description: "Smooth ride via the Mumbai-Pune Expressway with a designated halt at food malls if requested." },
      { day: "Drop Off", description: "Direct drop to your Mumbai destination, be it airport or office." }
    ]
  },
  {
    slug: "pune-shirdi",
    ...
    duration: "~4 hrs",
    startingPrice: "₹3,200",
    image: "https://images.unsplash.com/photo-1623888365612-40e13bc30e4b?w=1200&auto=format&fit=crop",
    ...
    itinerary: [
      { day: "Pick Up", description: "Early morning pick-up recommended from Pune." },
      { day: "Journey", description: "Scenic route through rural Maharashtra." },
      { day: "Arrival", description: "Drop at your hotel in Shirdi or close to the temple premises." }
    ]
  },
  {
    slug: "pune-nashik",
    ...
    duration: "~4.5 hrs",
    startingPrice: "₹3,500",
    image: "https://images.unsplash.com/photo-1596568359543-98782a20b22a?w=1200&auto=format&fit=crop",
  ...
  },
  {
    ...
    duration: "~3.5 hrs",
    startingPrice: "₹3,000",
    image: "https://images.unsplash.com/photo-1593693397690-362bc174275d?w=1200&auto=format&fit=crop",
    description: "Weekend getaway to the misty hills.",
    inclusions: ["Toll Taxes", "Professional Driver", "Fuel", "AC Vehicle"],
    exclusions: ["Parking (if any)", "Driver Allowance", "Local Sightseeing Fees"],
    itinerary: [
      { day: "Pick Up", description: "Morning departure from Pune." },
      { day: "Journey", description: "Ascent through the beautiful Surur & Pasarni Ghats." },
      { day: "Arrival", description: "Drop at your resort in Mahabaleshwar or Panchgani." }
    ]
  },
  {
    slug: "mumbai-nashik",
    ...
    duration: "~3.5 hrs",
    startingPrice: "₹3,400",
    image: "https://images.unsplash.com/photo-1616053351336-e8d1c7d2bd54?w=1200&auto=format&fit=crop",
    description: "Direct connection from Mumbai to Nashik.",
    inclusions: ["Toll Taxes", "Professional Driver", "Fuel", "AC Vehicle"],
    exclusions: ["Parking (if any)", "Driver Allowance"],
    itinerary: [
      { day: "Pick Up", description: "Pick-up from Mumbai Airport or city limits." },
  ...
  },
  {
    ...
    duration: "~1.5 hrs",
    startingPrice: "₹1,800",
    image: "https://images.unsplash.com/photo-1598444733470-3d8426090ee5?w=1200&auto=format&fit=crop",
    description: "Quick escape to the nearest hill station.",
    inclusions: ["Toll Taxes", "Professional Driver", "Fuel", "AC Vehicle"],
    exclusions: ["Parking (if any)", "Driver Allowance"],
    itinerary: [
      { day: "Pick Up", description: "Convenient start from anywhere in Pune." },
      { day: "Journey", description: "Short ride via Old Highway or Expressway." },
      { day: "Arrival", description: "Drop at your Lonavala villa or resort." }
    ]
  }
];

...
export const fleet = [
  ...
  },
  {
    ...
    ratePerKm: "₹16/km",
    image:
      "https://images.unsplash.com/photo-1669023414162-8b0573b9c6b2?w=1200&auto=format&fit=crop",
...
export const packages = [
  ...
  },
  {
    ...
    itinerary: [
      {
        day: "Pick Up",
        description: "Pick-up from your Pune location.",
      },
      {
        day: "Journey",
        description: "Travel via the NH60 highway.",
      },
      {
        day: "Arrival",
        description: "Drop anywhere in Nashik city limits.",
      },
    ],
  },
  {
    ...
    itinerary: [
      {
        day: "Pick Up",
        description: "Morning departure from Pune.",
      },
      {
        day: "Journey",
      ...
      },
      {
        day: "Arrival",
        description:
          "Drop at your resort in Mahabaleshwar or Panchgani.",
      },
    ],
  },
  {
    ...
    itinerary: [
      ...
      {
        day: "Journey",
        description: "Journey via Kasara Ghat.",
      },
      {
        day: "Arrival",
        description: "Arrival in Nashik.",
      },
    ],
  },
  {
